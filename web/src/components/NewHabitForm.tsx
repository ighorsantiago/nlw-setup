...
import * as Chekcbox from '@radix-ui/react-checkbox';
import { api } from "../lib/axios";

const availableWweekDays = ['Domingo', 'Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'Sábado'];
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <div className="flex flex-col gap-2 mt-3">
                {
                    availableWweekDays.map((weekDay, index) => (
                        <Chekcbox.Root
                            key={weekDay}
